...
if make_pred:
    ...
    st.header(f"Checkpoint 1 (25th percentile) - {round(sales_weeks_pred['Cummulated Sales Prediction'].quantile(0.25))}")
    st.header(f"Checkpoint 2 (50th percentile) - {round(sales_weeks_pred['Cummulated Sales Prediction'].quantile(0.5))}")
    st.header(f"Checkpoint 3 (90th percentile) - {round(sales_weeks_pred['Cummulated Sales Prediction'].quantile(0.9))}")
